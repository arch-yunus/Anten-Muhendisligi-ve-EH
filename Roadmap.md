# 🗺️ Anten Mühendisliği Eğitim Yol Haritası (Roadmap)

Bu yol haritası, bir araştırmacının veya mühendisin temel elektromanyetik teoriden başlayarak ileri seviye Elektronik Harp (EH) teknolojilerine kadar uzmanlaşmasını sağlayacak şekilde tasarlanmıştır.
...
- [Python Hesaplama Araçları](Scripts/README.md)
- [CST/HFSS Simülasyon Şablonları](Simulation/README.md)
